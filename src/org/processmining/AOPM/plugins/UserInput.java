...
import org.processmining.AOPM.help.YourHelp;
...
@Plugin(name = "AOPM", parameterLabels = { "Not specified", "Not specified", "Simulator settings" },
	    returnLabels = { "AOPM Simulator" }, returnTypes = { Simulator.class }, help = YourHelp.TEXT)
public class UserInput extends YourAlgorithm {
	...
	public Simulator runUI(UIPluginContext context, YourFirstInput input1, YourSecondInput input2) {
		// Get the default parameters.
	    YourParameters parameters = new YourParameters(input1, input2);
	    // Get a dialog for this parameters.
	    InputDialog dialog = new InputDialog(context, input1, input2, parameters);
	 ...
	 */
	@UITopiaVariant(affiliation = "PADS", author = "Gyunam Park", email = "gnpark@pads.rwth-aachen.de")
	@PluginVariant(variantLabel = "AOPM, simulator settings", requiredParameterLabels = { })
