...
public class YourAlgorithm {
	...
	public Simulator apply(PluginContext context, ProcessSimulation input1, YourParameters parameters) {
		/**
		 * Put your algorithm here, which computes an output form the inputs provided the parameters.
		 */
		long time = -System.currentTimeMillis();
	...
	public Simulator apply(PluginContext context, YourParameters parameters) {
		/**
		 * Put your algorithm here, which computes an output form the inputs provided the parameters.
		 */
		long time = -System.currentTimeMillis();
