...
@Plugin(name = "Artificial Information System", parameterLabels = { "Not specified", "Not specified", "Simulator settings" },
	    returnLabels = { "Artificial Information System" }, returnTypes = { ProcessSimulation.class })
public class ExampleInformationSystem extends EISAlgorithm {
	...
	@PluginVariant(variantLabel = "Artificial Information System", requiredParameterLabels = { })
